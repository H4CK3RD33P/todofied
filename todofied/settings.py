"""
Django settings for todofied project.
...
SECRET_KEY = '1xk%a2ib@h@d+s8rwtgmk)6%owfivk%nde8o20eo*8rkc)j+h-'
...
WSGI_APPLICATION = 'todofied.wsgi.application'
